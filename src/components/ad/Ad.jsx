      ...
      <div className="relative w-full bg-white dark:bg-black duration-500">
        <div className="con mx-auto z-[999] relative">
          <div className="c-flex">
            ...
            <div className="w-[50%] px-[26.4px] text-[45px] font-semibold text-center leading-[55px] cursor-pointer">
              <FaInstagram className="text-[#448c74] mx-auto" />
              <h1 className="pt-[25px] text-black dark:text-gray-200">Follow us</h1>
